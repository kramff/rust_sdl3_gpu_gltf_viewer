...
fn load_model() -> Model {
    // Open model file
    let (model_gltf, buffers, _images) = gltf::import("models/Low-Poly-Base_copy.glb").unwrap();
...
pub fn main() {
    ...
    'running: loop {
        ...
        for primitive_buffer_struct in &primitive_buffer_struct_vec {
